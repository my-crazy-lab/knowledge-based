...
- Irony: Chính những dự án này mới cần DDD nhất – để gỡ rối, phục hồi domain knowledge, và tổ chức lại hệ thống.
...
- snowflake schema
    ...
    - Việc chuẩn hoá thêm này giúp mô hình tiết kiệm không gian lưu trữ hơn và dễ bảo trì hơn. Tuy nhiên, để truy vấn dữ liệu từ fact sẽ cần nối (join) nhiều bảng hơn, dẫn đến việc tiêu tốn nhiều tài nguyên tính toán hơn.
